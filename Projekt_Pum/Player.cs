...
namespace Projekt_Pum
{
    class Player
    {
        ...
        private int milliseconsuPerFrame = 180;
        ...
        public void Move(int direction, List<Texture2D> tx)
        {
            switch (direction)
            {
                ...
                case 1: { Texture = tx[0]; PosX += 4; break; }
                case 2: { Texture = tx[1]; PosX -= 4; break; }
                case 3: { Texture = tx[2]; PosY -= 4; break; }
                case 4: { Texture = tx[3]; PosY += 4; break; }
                default: break;
            }
        }
